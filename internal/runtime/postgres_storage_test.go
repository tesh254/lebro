...
func newTestPostgresStore(t *testing.T) *PostgresStore {
	...
	for _, table := range []string{"schedule_executions", "working_memory_facts", "schedules", "workflow_snapshots", "workflow_runs", "messages", "threads", "run_events", "model_attempts", "tool_executions", "media_jobs", "schema_migrations"} {
